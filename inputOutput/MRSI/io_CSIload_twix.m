...
%Above is from OSPREY - PT, 2023
    ...
    %needed for niimrs conversion, from osprey - PT, 2023
    ...
    MRSIStruct.OriginalFile=twix_obj.image.filename;
    
    %PT - 2023
    MRSIStruct.nucleus=nucleus;
    MRSIStruct.gamma=gamma;
    MRSIStruct.hdr=twix_obj.hdr;
    MRSIStruct.filename=filename;
end
