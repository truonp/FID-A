function nii_hdr = osp_generate_nii_hdr_mrsi(in,nii_hdr,outfile)
...
%       2023-03-06: First version of the code.
    ...
    nii_hdr.pixdim(5) = in.spectralDwellTime;
    nii_hdr.pixdim(6) = 1;
    nii_hdr.pixdim(7) = 1;
    nii_hdr.pixdim(8) = 1;
    ...
    nii_hdr.pixdim(2)=nii_hdr.pixdim(2)/nii_hdr.dim(2);
    nii_hdr.pixdim(3)=nii_hdr.pixdim(3)/nii_hdr.dim(3);
    nii_hdr.pixdim(4)=nii_hdr.pixdim(4)/nii_hdr.dim(4);
